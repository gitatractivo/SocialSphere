  ...
  create: protectedProcedure
    ...
    .mutation(
      async ({
        ...
        // const filesjson:string[] = JSON.parse(files )
        //cloudinary
    ...
    posts: data.map((post) => {
      return {
        ...
        commentTO: {
          ...
          content: post?.commentTO?.content ,
          ...
          likedByMe: (post?.commentTO?.likes.length ??0 ) > 0,
        },
        ...
        repostTo: {
          ...
          likedByMe: (post?.repostTo?.likes.length ??0) > 0,
        },
      };
    }),
    nextCursor,
